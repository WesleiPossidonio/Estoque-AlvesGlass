...
interface CarpentryProps {
  categories: GetCategorySectionProps[]
  id: string
}

export const Carpentry = ({ categories, id }: CarpentryProps) => {
            ...
            <DialogTrigger asChild>
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-xl bg-base-blue flex items-center justify-center">
                ...
                <div className="flex items-center justify-center gap-7">
                  <span className="text-base-blue font-bold text-xl">
                    {item.quantity}
                  </span>
                </div>
